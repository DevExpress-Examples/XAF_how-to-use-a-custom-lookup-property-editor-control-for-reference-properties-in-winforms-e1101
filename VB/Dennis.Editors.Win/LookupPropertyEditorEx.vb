...
Namespace Dennis.Editors.Win
	...
	Public Class LookupPropertyEditorEx
		...
		Private Sub AddNewObject()
			...
			Dim newObjectViewObjectSpace As ObjectSpace = helper_Renamed.Application.CreateObjectSpace()
	...
	Public Class RepositoryItemLookUpEditEx
		...
		Private ReadOnly Property DisplayMember() As String Implements ILookupEditRepositoryItem.DisplayMember
			...
			End Get
		End Property
		Private ReadOnly Property IsFilterByValueSupported() As Boolean Implements ILookupEditRepositoryItem.IsFilterByValueSupported
			Get
				Return True
			End Get
		End Property
